  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      workers.forEach((w, i) => {
        ...
        if (isDissonant) {
          stateColor = 0xff1100;
          stateIntensity = 80 + Math.sin(t * 120) * 40;
          jitter = 0.25;
        ...
        if (agentTruth > TRUTH_THRESHOLD && Math.random() > 0.99) {
          ...
          (w.material as THREE.MeshStandardMaterial).emissiveIntensity = 100;
