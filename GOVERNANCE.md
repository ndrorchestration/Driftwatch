...
Driftwatch is the phi-drift monitoring substrate of the DGAF ecosystem. This repo governs harmonic state detection, PDMAL convergence drift alerts, and the Ionian/non-Ionian harmonic boundary enforcement layer. It is the live telemetry surface for drift-vs-hallucination detection across the agent lattice.

## Applicable Protocols

- **P-32** Fibonacci Phi-Closure Gate (BLOCKING) — primary drift gate
- **P-33** PDMAL Convergence Monitor (ADVISORY) — convergence surface
- **P-29** Sentinel-Annotated Risk Pass (BLOCKING) — safety hook
- **P-31** SCPE — Structural Context Pruning Engine (ADVISORY)
- **P-38** Circuit-Breaker with HITL Escalation (BLOCKING)
